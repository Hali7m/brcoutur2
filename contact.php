...
<?php if (isset($_SESSION['errors_contact'])): ?>
    <div class="alert alert-danger text-center mb-3">
        <ul>
            <?php foreach ($_SESSION['errors_contact'] as $error): ?>
                <li><?php echo htmlspecialchars($error); ?></li>
            <?php endforeach; ?>
        </ul>
    </div>
    <?php unset($_SESSION['errors_contact']); ?>
<?php endif; ?>

<?php if (isset($_SESSION['success_contact'])): ?>
    <div class="alert alert-success text-center">
        <?php echo htmlspecialchars($_SESSION['success_contact']); ?>
...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <div class="text-center my-4 social-icons">
            <a href="#" class="facebook me-3"><i class="fab fa-facebook fa-shake fa-2x"></i></a>
            <a href="#" class="instagram me-3"><i class="fab fa-instagram fa-shake fa-2x"></i></a>
            <a href="#" class="whatsapp me-3"><i class="fab fa-whatsapp fa-shake fa-2x"></i></a>
            <a href="#" class="viber me-3"><i class="fab fa-viber fa-shake fa-2x"></i></a>
            <a href="#" class="facebook me-3"><i class="fab fa-telegram fa-shake fa-2x"></i></a>
        </div>
    </div>
    <hr class="my-4" style="width: 60%; margin: auto; border-top: 2px solid #000;" />
