            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark">Prix : 20,000 DA</p>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark">Prix : 5,000 DA</p>
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark">Prix : 35,000 DA</p>
...
<!-- Nos Marques Section -->
    <div class="my-5">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-4 mb-4">
                <div class="brand-card text-center">
                    <img src="public/image/precious.jpg" class="img-fluid" alt="Precious" style="height: 100px; object-fit: contain;">
                </div>
            </div>
        </div>
    </div>
